...
Now that we’ve planned out what we want to build, it’s time to [diagram an Idea in firstdraft.](https://learn.firstdraft.com/lessons/243-diagramming-your-domain-model)
